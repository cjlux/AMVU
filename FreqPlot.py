...
"""
    Class for frequential plot management
...
class FreqPlot(Plot):
    ...
    def setVerticalScale(self, maxValue):
        self.setAxisScale (Qwt.QwtPlot.yLeft, 0, maxValue, 0)
        self.setAxisScale (Qwt.QwtPlot.yRight, 0, maxValue, 0) 	
        self.updateAxes()
